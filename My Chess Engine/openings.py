...
def detect_opening(board):
    ...
    # simplier epd for opening generic lookup (ignoring clocks)
...
ECO_DB = {
    ...
    "r1bqkbnr/pppp1ppp/2n5/4p3/4P3/2N2N2/PPPP1PPP/R1BQKB1R w KQkq -": ("C47", "Four Knights Game"), # Wait 3 vs 4 logic is tricky with just FEN, order matters less
    ...
    "rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR w KQkq -": ("D06", "Queen's Gambit"), # Wait color
